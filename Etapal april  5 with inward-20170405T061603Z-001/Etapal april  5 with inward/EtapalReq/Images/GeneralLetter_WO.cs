    ...
    public partial class GeneralLetter_WO : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //MessageBox.Show("Please enter value for ApplicantName"); 
        ...
        private void Save_General_Letter()
        {
            try
            {
                ...
                string InsertData = "Insert into tblReceiverNew(General_Letter,Letter_No,Received_Date,Letter_Date,Other_Dept,Subject,ToSection,ToCaseWorker,Applicant_Name,Hobli,Village,Survey_No)" +
                               "values(@General_Letter,@Letter_No,@Received_Date,@Letter_Date,N'" + txtDeptOthers.Text + "',N'" + txtSubject.Text + "',N'" + cbToSection.Text + "',N'" + cbToCaseWorker.Text + "',N'" + txtApplicantName.Text + "',N'" + txtHobli.Text + "',N'" + txtVillage.Text + "',N'" + txtSurveyNo.Text + "')";
        ...
        private void txtSubject_Click(object sender, EventArgs e)
        {
            try
            {
                    txtSubject.Text = " ಅರ್ಜಿದಾರರ ಹೆಸರು : " + txtApplicantName.Text + Environment.NewLine + " ಹೋಬಳಿ" + txtHobli.Text + Environment.NewLine + "ಗ್ರಾಮ : " + txtVillage.Text + Environment.NewLine + " ಕಡತ / ಪತ್ರದ ಸಂಖ್ಯೆ : " + txtLetterNumber.Text + Environment.NewLine + " ಸಮೀಕ್ಷೆ ಸಂಖ್ಯೆ : " + txtSurveyNo.Text;
            }
            catch (Exception)
            {
