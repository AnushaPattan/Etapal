...
namespace EtapalReq
{
    public partial class SearchGeneral_IN : Form
    {
       ...
       // SqlConnection conn = new SqlConnection(@"data source=SOUTH-PC;initial catalog=EtapalReqWO;integrated security=true");
        ...
        public SearchGeneral_IN()
        {
            InitializeComponent();
        }

        private void SearchGeneral_IN_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void Search_General_Letter()
        {
            try
            {
                ...
                string General_Letter = "Select General_Letter,Applicant_Name,Hobli,Village,Received_Date,Letter_Date,Letter_No,Survey_No,From_Other_Dept,ToSection,ToCaseWorker,Subject,GL_No_Id,Inward_No,ToSubsection from tblGeneralLetter_IN where General_Letter = @p1";
        ...
        private void Search_GL_No()
        {
            try
            {
                string GL_No = "Select General_Letter,Applicant_Name,Hobli,Village,CONVERT(varchar, Received_Date, 103) as ReceivedDate,Letter_Date,Letter_No,Survey_No,From_Other_Dept,ToSection,ToCaseWorker,Subject,GL_No_Id,Inward_No,ToSubsection from tblGeneralLetter_IN  where  GL_No_Id ='" + txtSearch.Text + "'";
        ...
        private void Search_Letter_Number()
        {
            try
            {
                ...
                string Letter_Number = "Select General_Letter,Applicant_Name,Hobli,Village,Received_Date,Letter_Date,Letter_No,Survey_No,From_Other_Dept,ToSection,ToCaseWorker,Subject,GL_No_Id,Inward_No,ToSubsection from tblGeneralLetter_IN where Letter_No = @p1";
        ...
        private void Search_Survey_Number()
        {
            ...
            {
                //string Letter_Number = "Select * from tblGovernmentLetter_WO where Letter_No = @p1";
                string Survey_Number = "Select General_Letter,Applicant_Name,Hobli,Village,Received_Date,Letter_Date,Letter_No,Survey_No,From_Other_Dept,ToSection,ToCaseWorker,Subject,GL_No_Id,Inward_No,ToSubsection  from tblGeneralLetter_IN where Survey_No = @p1";
        ...
        private void Search_Subject()
        {
            try
            {
                ...
                s = "Select General_Letter,Applicant_Name,Hobli,Village,Received_Date,Letter_Date,Letter_No,Survey_No,From_Other_Dept,ToSection,ToCaseWorker,Subject,GL_No_Id,Inward_No,ToSubsection from tblGeneralLetter_IN R";
                //  s = string.Concat(s);
        ...
        private void Search_Inward_No()
        {
            ...
            {
                //string Letter_Number = "Select * from tblGovernmentLetter_WO where Letter_No = @p1";
                string Inward_No = "Select General_Letter,Applicant_Name,Hobli,Village,Received_Date,Letter_Date,Letter_No,Survey_No,From_Other_Dept,ToSection,ToCaseWorker,Subject,GL_No_Id,Inward_No,ToSubsection  from tblGeneralLetter_IN where Inward_No = @p1";
        ...
        private void dataGridViewSearch_General_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (dataGridViewSearch_General.Columns[e.ColumnIndex].Name == "GlNo")
                {
                    ...
                    string GLNoId = dataGridViewSearch_General.Rows[e.RowIndex].Cells[13].Value.ToString();
                    string InwardNo = dataGridViewSearch_General.Rows[e.RowIndex].Cells[14].Value.ToString();
                    string ToSubsection = dataGridViewSearch_General.Rows[e.RowIndex].Cells[15].Value.ToString();
